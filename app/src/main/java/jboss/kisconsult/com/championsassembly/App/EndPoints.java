...
public class EndPoints {
    public static final String BASE_URL = "http://192.168.43.240/sbc/v1";
    public static final String IMG_BASE_URL = BASE_URL.replace("v1", "");
    public static final String USER_LOGIN = BASE_URL + "/member/login";
    public static final String USER_REGISTER = BASE_URL + "/member/register";
